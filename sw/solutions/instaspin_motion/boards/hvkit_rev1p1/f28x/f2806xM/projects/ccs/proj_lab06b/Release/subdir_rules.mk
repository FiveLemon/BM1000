...
proj_lab06b.obj: D:/FOC_69/sw/solutions/instaspin_motion/src/proj_lab06b.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv6/tools/compiler/c2000_6.2.5/bin/cl2000" -v28 -ml -mt --cla_support=cla0 --float_support=softlib --vcu_support=vcu0 -O2 --include_path="D:/FOC_69/sw/modules/hal/boards/hvkit_rev1p1/f28x/f2806x/src/" --include_path="C:/ti/ccsv6/tools/compiler/c2000_6.2.5/include" --include_path="D:/FOC_69/sw/solutions/instaspin_motion/boards/hvkit_rev1p1/f28x/f2806xM/src" --include_path="D:/FOC_69" -g --define=FAST_ROM_V1p6 --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="proj_lab06b.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
