...
#define LDC161x_Kalman_Q                (uint32_t)(150)
#define LDC161x_Kalman_R                (uint32_t)(15000)

#define CH_NUM_1  1601
#define CH_NUM_2  1602
#define CH_NUM_3  1603
#define CH_NUM_4  1603

#define USE_CH_NUM  CH_NUM_1
...
typedef struct _LDC161x_Kalman_t_
{
  ...
  uint32_t         p_Last;
  uint32_t         data_Last;
  uint32_t         Ldc_Kalman_R;
  uint32_t         Ldc_Kalman_Q;
} LDC161x_Kalman_t_;
