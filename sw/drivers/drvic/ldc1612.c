...
void LDC161x_ReFilter(LDC161x_Handle handle,const LDC161x_ChNum_e ChNum,uint32_t *drvDataGet)
{
    ...
    static uint32_t   oldData = 14800000;
...
void LDC161x_KalmanFilter(LDC161x_Handle handle,const LDC161x_ChNum_e ChNum,uint32_t *drvDataGet)
{
    ...
    p_Mid = obj->ldc161x.LdcKalman.p_Last + obj->ldc161x.LdcKalman.Ldc_Kalman_Q;//LDC161x_Kalman_Q;
    
    Kg = (1.0 * p_Mid)/(p_Mid + obj->ldc161x.LdcKalman.Ldc_Kalman_R);//LDC161x_Kalman_R
...
void LDC161xReg_ReConfig(LDC161x_Handle handle)
{
  ...
  LDC161x_readChData(handle,LDC161x_ChNum_CH0);
...
void LDC161x_Kalman_init(LDC161x_Handle handle, uint32_t LdcKalman_R, uint32_t LdcKalman_Q)
{
	LDC161x_Obj *obj = (LDC161x_Obj *)handle;

	 obj->ldc161x.LdcKalman.Ldc_Kalman_R = LdcKalman_R;
	 obj->ldc161x.LdcKalman.Ldc_Kalman_Q = LdcKalman_Q;
